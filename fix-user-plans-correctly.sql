...
-- This detects what users actually paid for based on their Stripe subscription
...
-- Now fix users based on their actual Stripe subscription
...
SET 
    ...
    credits_remaining = CASE 
        -- Assign correct credits based on plan
...
DO UPDATE SET 
    images_limit = CASE excluded.images_limit
        WHEN 150 THEN 150  -- basic
        WHEN 400 THEN 400  -- pro
        WHEN 1300 THEN 1300 -- premium
        ELSE 150
    END;
