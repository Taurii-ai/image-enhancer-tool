      ...
      if (signupMethod === 'email') {
        ...
        if (data.user) {
          toast({
            ...
            description: 'Please check your email to confirm your account, then choose a subscription plan.',
          });
                  ...
                  {signupMethod === 'email' ? (
                    <form onSubmit={handleSignup} className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        You'll choose a subscription plan after creating your account.
                      </p>
                    </form>
                  ) : (
                    <div className="space-y-4">
                      ...
                      <p className="text-xs text-muted-foreground text-center">
                        You'll choose a subscription plan after signing up.
                      </p>
                    </div>
                  )}
                </div>
